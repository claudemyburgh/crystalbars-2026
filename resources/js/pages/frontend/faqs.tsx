                ...
                <div className="mx-auto w-full max-w-7xl px-4 py-20">
                    <div className="grid items-center gap-8 md:grid-cols-2">
                        <div>
                            ...
                            <p className="mt-3 text-neutral-600 dark:text-neutral-300">Answers to common questions about our crystal bars, installations, timelines, and more.</p>
                            <div className="mt-6">
                        ...
                        <div className="rounded-xl border border-sidebar-border/60 bg-linear-to-br from-primary/10 to-accent/10 p-8">
                            <div className="text-sm text-neutral-700 dark:text-neutral-200">Still have questions? Call 079 491 2812, WhatsApp 072 755 4303, or email info@crystalbars.co.za.</div>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="mx-auto w-full max-w-3xl px-4 py-12">
                ...
                <div className="mt-6">
                    <Accordion type="single" className="space-y-3">
                        {
                            faqs.map((item) => (
                            <AccordionItem key={item.id} value={String(item.id)} className="rounded-lg border bg-card text-card-foreground shadow-sm">
                                ...
                                <AccordionContent className="px-4 pb-4 text-muted-foreground leading-7 md:px-6">
                                    {item.answer}
                                </AccordionContent>
                            </AccordionItem>
                        ))}
